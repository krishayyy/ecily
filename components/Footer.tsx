...
export default function Footer() {
  return (
    <footer className="bg-ink px-8 py-10">
      <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-5">
        ...
        <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-xs text-cream/35 font-mono">
          ...
          <a href={`mailto:${CONTACT_EMAIL}`} className="hover:text-cream/70 transition-colors duration-200">Contact</a>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <span className="text-xs text-cream/30 font-mono">© 2026 Ecily</span>
        </div>
      </div>
    </footer>
  )
