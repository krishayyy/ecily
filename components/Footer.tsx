    ...
    <footer className="bg-[#FBF6EC] border-t border-black/[0.07] px-8 py-10">
      <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-5">
        ...
        <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-xs text-[#1C1A16]/40 font-mono">
          <Link href="/#chapters" className="hover:text-[#1C1A16]/70 transition-colors duration-200">Chapters</Link>
          <Link href="/team" className="hover:text-[#1C1A16]/70 transition-colors duration-200">Team</Link>
